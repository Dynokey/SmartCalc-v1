...
{
  //  if(global::flag_dep_or_credit == true){
  //      ui->pushButton_Credit->hide();
  //  } else {
  //      ui->pushButton_Deposit->hide();
  //  }
...
void sparrvio::on_pushButton_eq_clicked() {
  ...
  if (global::flag_x_value == true) {
    ...
    ui->repeat_result->setText(ui->repeat_result->text() + " = " +
                               ui->result->text());
    global::x_value = 0.0;
    global::flag_x_value = false;
  }
...
void sparrvio::on_pushButton_Deposit_clicked() {
  ui->pushButton_Deposit->hide();
  ui->pushButton_Credit->show();
  Deposit window;
  window.setModal(true);
  window.exec();
}
